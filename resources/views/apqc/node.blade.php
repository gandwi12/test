<details name="apqc-group-{{ $process->parent_id ?? 'root' }}" class="mb-2 bg-white rounded-lg shadow-sm border border-gray-200">
    ...
    <div class="p-4 border-t border-gray-100 bg-gray-50 ml-4 border-l-2 border-blue-200">
        ...
        @if($process->metrics->isNotEmpty())
            <details name="metrics-group-{{ $process->id }}" class="mb-4 bg-blue-50 p-3 rounded border border-blue-200">
                <summary class="cursor-pointer p-2 text-sm font-bold text-blue-800 mb-2 hover:bg-blue-100 bg-blue-50 rounded mb-2">
                    Metrics:
                </summary>
